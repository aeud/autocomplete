...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=7619157250410a37e887)
 * Config saved to config.json and https://gist.github.com/7619157250410a37e887
 */
                    ...
                    t = setTimeout(function(){
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                results = data.results.map(function(hit, _i){
                                    switch(hit.type) {
                                        case 'query':
                                            iconHTML = 'search';
                                            break;
                                    ...
                                    var icon = $('<i>').attr('class', 'material-icons').html(iconHTML);
                                    var span = $('<span>').attr('class', 'autocomplete-result-content').html(hit.name);
                                    var a = $('<a>').attr('href', hit.self_link).attr('class', 'autocomplete-result-link').append(icon).append(span);
